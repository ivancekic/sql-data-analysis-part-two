                    ...
                    SELECT /*+ RULE */ MAG_PR_DatPS.org_deo,
                           ...
                           (Select Sum(Round(NVL(Kolicina * Faktor * K_Robe, 0), 4))
                             ...
                             Where Dokument.Vrsta_Dok = Stavka_Dok.Vrsta_Dok
	                           ...
	                           and (DOKUMENT.org_deo BETWEEN 300 AND 517 and Dokument.Status = 1)
                            ...
                            (Select sum(Round(NVL(Kolicina * Faktor * K_Robe, 0), 4))
                             ...
                             Where Dokument.Vrsta_Dok = Stavka_Dok.Vrsta_Dok
	                           ...
	                           and (DOKUMENT.org_deo BETWEEN 300 AND 517 and Dokument.Status = 1)
                               And (
	                                    (DOKUMENT.org_deo BETWEEN 300 AND 517 and Dokument.Status = 1)
                                     or
	                                    (DOKUMENT.org_deo not BETWEEN 300 AND 517 and Dokument.Status > 0)
                                   )
                               And Stavka_Dok.K_Robe != 0
                      ...
                      FROM (SELECT distinct D1.ORG_DEO,
                                   ...
                                   (SELECT nvl(MAX(DATUM_DOK), to_date('01.01.' || to_char(&NaDan, 'yyyy'), 'dd.mm.yyyy')) ---ZAMENITI SYSDATE
                                     ...
                                     WHERE 0 < D2.status
	                                   ...
	                                   and (d2.org_deo BETWEEN 300 AND 517 and d2.Status = 1)
                                    ) DATUM_PS
                              FROM DOKUMENT D1,
                                   STAVKA_DOK SD1
                             WHERE SD1.VRSTA_DOK = D1.VRSTA_DOK
                               ...
                               and (d1.org_deo BETWEEN 300 AND 517 and d1.Status = 1)
