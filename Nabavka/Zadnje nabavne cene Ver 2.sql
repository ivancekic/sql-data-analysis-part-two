select sd.proizvod, p.naziv naziv_pro, d.org_deo, od.naziv naziv_pro
,
(
    select sd2.cena
...
Where
  ...
  and d.org_deo not between 123 and 118
  and d.org_deo not between 300 and 500

--  and org_deo between 500 and 520
