...
(
   select
        ...
        , pm.vrsta pm_vrsta
        , plt.DATUM_OD plt_datum_od, plt.DATUM_DO plt_datum_do
     ...
     from planiranje_stavka ps
        ...
        , (Select * from planiranje_mapiranje
           where vrsta = 'GOT_PROIZVODI_TIPOVI') pm
        , planiranje_trajanje plt
	where
      ...
      and plt.PLAN_CIKLUS_ID = ps.plan_ciklus_id
      and plt.PLAN_PERIOD_ID = ps.plan_period_id
      and plt.TRAJANJE_ID    = ps.plan_trajanje_id
)
