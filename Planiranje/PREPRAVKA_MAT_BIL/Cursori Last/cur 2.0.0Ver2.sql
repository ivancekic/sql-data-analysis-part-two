				Select plan.PLAN_CIKLUS_ID, plan.PLAN_CIKLUS_NAZIV
				     ...
				     , plan.GPR_SAST, plan.gotov_pr_sast_sarza, plan.gotov_pr_plan_umnozak_sarze
				...
				(
					select plzag.PLAN_CIKLUS_ID, plcik.ciklus_naziv PLAN_CIKLUS_NAZIV
					     ...
					     , plstav.kolicina
					     , plstav.BROJ_SASTAVNICE GPR_SAST, sz.kolicina gotov_pr_sast_sarza
		                 , plstav.kolicina/nvl(sz.kolicina,1)           gotov_pr_plan_umnozak_sarze
					...
					from PLANIRANJE_CIKLUS			plcik
					   ...
					   , posebna_grupa				pgr
					   , tip_proizvoda				tp
					   , (Select * from sastavnica_zag where godina = 0 and broj_dok <> ' ')				sz
					where
					  ...
					  and sz.broj_dok=plstav.BROJ_SASTAVNICE
