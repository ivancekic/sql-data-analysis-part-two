			select
				...
				, ROUND(plan.MATERIJAL_ZADNJA_NABAVNA_CENA,5) MATERIJAL_ZADNJA_NABAVNA_CENA
				, plan.MATERIJAL_POSGR
				, pg.naziv		MATERIJAL_POSGR_NAZIV
				, ROUND(nabavljeno,5) nabavljeno
...
--					WHERE pm.magacin_id=dp.org_Deo
					WHERE pm.org_deo_id= &p_org_deo_id and pm.magacin_id=dp.org_Deo
			          and dp.broj_dok>0
			          and dp.vrsta_Dok > '0'
