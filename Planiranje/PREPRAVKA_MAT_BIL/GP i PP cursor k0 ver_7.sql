	SELECT
	     ...
	     , plan.GOTOV_PR_PLAN_ZELJENA_KOL - ost_plan_gp_pp_kol
	     , plan.TIP_PROIZVODA
...
--	    and dp.org_Deo = pm.vrednost
	...
	(
		 select
				         gotov_pr_sifra ost_plan_gp_pp_sifra
	                   , gotov_pr_plan_zeljena_kol ost_plan_gp_pp_kol
			  ---------------------------------------------------------------------------------------------------
...
--			  and  varijanta_id     = &c_varijanta_id
    ...
    WHERE plan.GOTOV_PR_SIFRA=D.PROIZVOD(+)
      ...
      And plan.GOTOV_PR_SIFRA=op.ost_plan_gp_pp_sifra (+)

      and plan.GOTOV_PR_SIFRA = '360187'
